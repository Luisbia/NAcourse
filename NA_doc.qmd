...
The output approach is the basis of the NA system^[<https://politicalarithmetick.com/2017/04/03/what-the-textbooks-get-wrong-when-they-explain-gdp/>]
...
In NAMA we will compile P1 by economic activity and in the supply table we will compile additionally by product.